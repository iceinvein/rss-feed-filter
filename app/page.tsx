		...
		<div className="space-y-6">
			...
			<div className="flex flex-col gap-4">
				...
				<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
					<Card className="border-none bg-gradient-to-br from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/20">
						<CardBody className="gap-1">
							<p className="text-default-600 text-sm">Total Notifications</p>
					...
					<Card className="border-none bg-gradient-to-br from-success-50 to-success-100 dark:from-success-900/20 dark:to-success-800/20">
						<CardBody className="gap-1">
							<p className="text-default-600 text-sm">Loaded</p>
					...
					<Card className="border-none bg-gradient-to-br from-secondary-50 to-secondary-100 dark:from-secondary-900/20 dark:to-secondary-800/20">
						<CardBody className="gap-1">
							<p className="text-default-600 text-sm">Active Filters</p>
