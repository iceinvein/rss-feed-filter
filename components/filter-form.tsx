    ...
    <Card className="w-full">
      ...
      <CardBody className="gap-4">
        ...
        <div className="space-y-2">
          <div className="text-sm font-medium">Title Must Include</div>
        ...
        <div className="space-y-2">
          <div className="text-sm font-medium">Title Must Exclude</div>
          <div className="flex gap-2">
            <Input
              placeholder="Add keyword..."
              value={titleExclude}
        ...
        <div className="space-y-2">
          <div className="text-sm font-medium">Description Must Include</div>
          <div className="flex gap-2">
            <Input
              placeholder="Add keyword..."
              value={descInclude}
        ...
        <div className="space-y-2">
          <div className="text-sm font-medium">Description Must Exclude</div>
          <div className="flex gap-2">
            <Input
              placeholder="Add keyword..."
              value={descExclude}
